          ...
          return (
            <div key={i} className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-all group">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[12px] font-semibold text-[var(--cms-text-secondary)] uppercase tracking-[0.1em] mb-2">{stat.label}</p>
              ...
              <div className="mt-6 flex items-center text-[10px] font-bold uppercase tracking-widest">
