...
async function reclassify() {
  ...
  const signalCategories = [
    ...
    { name: 'Founder Story / Profile', priority: 10, strong: ['founder op-ed', 'founder profile', 'in conversation with', 'interview with founder', 'exclusive interview', 'founder exclusive', 'interview with ceo', 'founder speaks', 'co-founder says', 'q&a with', 'story of', 'how it started'], supporting: ['opinion', 'thought leadership', 'vision', 'roadmap', 'op-ed by', "founder's take", 'startup journey', 'lessons from', 'we sat down with', 'in their own words', 'built', 'started by', 'founder story', 'founder', 'ceo', 'entrepreneur', 'co-founder'] },
